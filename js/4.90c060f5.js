...
// CONCATENATED MODULE: ./src/components/tools/Tuner.vue?vue&type=template&id=0f8dfd96&
...
Tuner.prototype.setup = function (stream) {
  ...
  self.audioContext = self.getAudioContext(); // if (!stream) stream = window.audioinput.getStream();
...
Tuner.prototype.stop = () => {
  ...
  (_self = self) === null || _self === void 0 ? void 0 : _self.oscillator.stop();
...
/* harmony default export */ var Tunervue_type_script_lang_js_ = ({
  ...
  computed: {
    ...
    appInfo() {
      ...
      return (_this$app2 = this.app) === null || _this$app2 === void 0 ? void 0 : _this$app2.info;
    },
    ...
    toggleTones: {
      get() {
        ...
        return !((_this$app3 = this.app) !== null && _this$app3 !== void 0 && _this$app3.notes.isAutoMode);
      },

      set(value) {
        var _this$app4;

        (_this$app4 = this.app) === null || _this$app4 === void 0 ? void 0 : _this$app4.notes.toggleAutoMode();
  ...
  methods: {
    getQ(obj) {
      ...
      return (_this$app5 = this.app) === null || _this$app5 === void 0 ? void 0 : _this$app5.getQVAR(obj);
    },
...
runtime_auto_import_default()(component, 'components', {QItem: QItem["a" /* default */],QItemSection: QItemSection["a" /* default */],QIcon: QIcon["a" /* default */],QFab: QFab["a" /* default */],QFabAction: QFabAction["a" /* default */],QToggle: QToggle["a" /* default */],QBtn: QBtn["a" /* default */],QDialog: QDialog["a" /* default */],QCard: QCard["a" /* default */],QCardSection: QCardSection["a" /* default */]});
...
//# sourceMappingURL=4.90c060f5.js.map