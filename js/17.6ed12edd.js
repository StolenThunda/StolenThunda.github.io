...
/* harmony default export */ var FavoritesListvue_type_script_lang_js_ = ({
  ...
  computed: { ...Object(vuex_esm["e" /* mapState */])("default", ["favorites"])
  },
  methods: {
    link(fav) {
      if (fav.src !== "Imported") {
    ...
    ...Object(vuex_esm["c" /* mapActions */])("default", ["removeFavorite"]),
    ...Object(vuex_esm["c" /* mapActions */])("watch", ["playSegment", "fetchPackage", "fetchDefaultMedia"])
  }
});
...
//# sourceMappingURL=17.6ed12edd.js.map